...
export function PingPongTexture( renderer, shader, width, height, format, type, buffersCount ) {
	...
	this.orthoQuad = new THREE.Mesh( new THREE.PlaneGeometry( 1, 1 ), this.shader );
